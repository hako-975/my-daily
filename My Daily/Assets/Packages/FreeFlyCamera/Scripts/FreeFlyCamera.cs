...
public class FreeFlyCamera : MonoBehaviour
{
    ...
    public JoyButton topButton;
    public JoyButton leftButton;
    public JoyButton rightButton;
    public JoyButton bottomButton;

    public JoyButton upButton;
    public JoyButton downButton;

    public TouchField touchFieldDrone;

    public float touchSensitivity = 80f;
    ...
    private void Update()
    {
        ...
        if (_enableRotation)
        {
            ...
            transform.rotation *= Quaternion.AngleAxis(
                -(touchFieldDrone.TouchDist.y / touchSensitivity) * _mouseSense,
                Vector3.right
            );
            ...
            transform.rotation = Quaternion.Euler(
                ...
                transform.eulerAngles.y + (touchFieldDrone.TouchDist.x / touchSensitivity) * _mouseSense,
